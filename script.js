...
// Dynamic Show Dates Logic
const shows = [
    {
        date: new Date('2026-02-14T23:59:59'),
        id: {
            day: "SABTU",
            month: "14 FEBRUARI"
        },
    ...
    {
        date: new Date('2026-06-06T23:59:59'),
        id: {
            day: "SABTU",
            month: "6 JUNI"
        },
...
function updateShowDates() {
    ...
    // Check if we are past the first show, second show, etc.
    if (now > shows[0].date) {
        currentShow = shows[1];
    }
    if (now > shows[1].date) {
    ...
    // Update the translation pairs for both languages
    translations.id["hero.date.day"] = currentShow.id.day;
    translations.id["hero.date.month"] = currentShow.id.month;
    translations.en["hero.date.day"] = currentShow.en.day;
    translations.en["hero.date.month"] = currentShow.en.month;
}
